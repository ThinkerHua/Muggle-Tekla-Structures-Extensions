...
namespace Muggle.TsExtensions.CodingHelper.Generators {
    ...
    public class BoltFieldDefaultValuesAttribute : Attribute {
        ...
        public BoltFieldDefaultValuesAttribute(
            ...
            double slottedHoleX = 0.0, double slottedHoleY = 0.0, double slotOffsetX = 0.0, double slotOffsetY = 0.0, 
            int rotateSlots = 2, int isBolt = 1, int useNut1 = 1, int useNut2 = 0, int useWasher1 = 0, 
            int useWasher2 = 0, int useWasher3 = 1) {
