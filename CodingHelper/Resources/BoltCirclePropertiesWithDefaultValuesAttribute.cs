...
namespace Muggle.TsExtensions.CodingHelper.Generators {
    ...
    public class BoltCirclePropertiesWithDefaultValuesAttribute : Attribute {

        /// <summary>
        /// Register bolt circle properties with default values using the given number.
        /// </summary>
        /// <param name="boltCircleNumber">The bolt circle number used for identification, not some kind of property.</param>
        ...
        /// <summary>
        /// Register bolt circle properties with default values using the given name.
        /// </summary>
        /// <param name="boltCircleName">The bolt circle name used for identification, not some kind of property.</param>
        /// <param name="size">The default value for the "BoltSize" property of "BoltGroup".</param>
        /// <param name="standard">The default value for the "BoltStandard" property of "BoltGroup".</param>
        /// <param name="numberOfBolts">The default value for the "NumberOfBolts" property of "BoltCircle".</param>
        /// <param name="diameter">The default value for the "Diameter" property of "BoltCircle".</param>
