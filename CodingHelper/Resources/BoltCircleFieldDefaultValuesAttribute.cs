...
namespace Muggle.TsExtensions.CodingHelper.Generators {
    ...
    public class BoltCircleFieldDefaultValuesAttribute : Attribute {
        ...
        /// </summary>
        /// <remarks>The preset default values is: Size = 8.0, Standard = "A", NumberOfBolts = 6, Diameter = 100.0,
        ...
        /// SlottedHoleX = 0.0, SlottedHoleY = 0.0, RotateSlots = 2, IsBolt = 1, UseNut1 = 1, UseNut2 = 0,
        /// UseWasher1 = 0, UseWasher2 = 0, UseWasher3 = 1.</remarks>
        /// <param name="id">The id registered by <see cref="BoltCircleFieldsAttribute"/>.</param>
        public BoltCircleFieldDefaultValuesAttribute(uint id) {
            Id = id.ToString();
            Size = 8.0;
            Standard = "A";
            NumberOfBolts = 6;
        ...
        /// UseWasher1 = 0, UseWasher2 = 0, UseWasher3 = 1.</remarks>
        /// <param name="id">The id registered by <see cref="BoltCircleFieldsAttribute"/>.</param>
        public BoltCircleFieldDefaultValuesAttribute(string id) {
            Id = id;
            Size = 8.0;
            Standard = "A";
            NumberOfBolts = 6;
        ...
        public BoltCircleFieldDefaultValuesAttribute(
            uint id, double size = 8.0, string standard = "A", int numberOfBolts = 6,
            double diameter = 100.0, int type = 0, int threadInMaterial = 1, double length = 40.0, 
            double cutLength = 100.0, double extraLength = 0.0, double tolerance = 2.0, int plainType = 0, 
            double blindHoleDepth = 0.0, int hole1 = 1, int hole2 = 1, int hole3 = 0, int hole4 = 0, int hole5 = 0, 
            int holeType = 0, double slottedHoleX = 0.0, double slottedHoleY = 0.0, int rotateSlots = 2, int isBolt = 1,
        ...
        /// <param name="useWasher3">The default value for the "Washer3" property of "BoltGroup".</param>
        public BoltCircleFieldDefaultValuesAttribute(
            string id, double size = 8.0, string standard = "A", int numberOfBolts = 6,
            double diameter = 100.0, int type = 0, int threadInMaterial = 1, double length = 40.0, 
            double cutLength = 100.0, double extraLength = 0.0, double tolerance = 2.0, int plainType = 0, 
            double blindHoleDepth = 0.0, int hole1 = 1, int hole2 = 1, int hole3 = 0, int hole4 = 0, int hole5 = 0, 
            int holeType = 0, double slottedHoleX = 0.0, double slottedHoleY = 0.0, int rotateSlots = 2, int isBolt = 1,
