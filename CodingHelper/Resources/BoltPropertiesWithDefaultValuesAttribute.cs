...
namespace Muggle.TsExtensions.CodingHelper.Generators {
    ...
    public class BoltPropertiesWithDefaultValuesAttribute : Attribute {
        
        /// <summary>
        /// Register bolt properties with default values using the given number.
        /// </summary>
        /// <param name="boltNumber">The bolt number used for identification, not some kind of property.</param>
        ...
        public BoltPropertiesWithDefaultValuesAttribute(uint boltNumber,
        ...
        /// <summary>
        /// Register bolt properties with default values using the given name.
        /// </summary>
        /// <param name="boltName">The bolt name used for identification, not some kind of property.</param>
        /// <param name="size">The default value for the "BoltSize" property of "BoltGroup".</param>
        /// <param name="standard">The default value for the "BoltStandard" property of "BoltGroup".</param>
        /// <param name="distX">The default value used by the "AddBoltDistX" method of "BoltArray" or "BoltXYList".</param>
        /// <param name="distY">The default value used by the "AddBoltDistY" method of "BoltArray" or "BoltXYList".</param>
        ...
        /// <param name="useWasher2">The default value for the "Washer2" property of "BoltGroup".</param>
        /// <param name="useWasher3">The default value for the "Washer3" property of "BoltGroup".</param>
        public BoltPropertiesWithDefaultValuesAttribute(string boltName,
            double size = 8.0, string standard = "A", string distX = "", string distY = "", int type = 0,
            int threadInMaterial = 1, double cutLength = 100.0, double extraLength = 0.0, double tolerance = 2.0,
            int plainType = 0, double blindHoleDepth = 0.0, int hole1 = 1, int hole2 = 1, int hole3 = 0, int hole4 = 0,
            int hole5 = 0, int holeType = 0, double slottedHoleX = 0.0, double slottedHoleY = 0.0, int rotateSlots = 2,
