...
namespace Muggle.TsExtensions.CodingHelper.Generators {
    ...
    public class BoltFieldDefaultValuesAttribute : Attribute {
        ...
        public string DistXText { get; set; }
        public string DistYText { get; set; }
        ...
        /// </summary>
        /// <remarks>The preset default values is: Size = 8.0, Standard = "A", DistXText = "", DistYText = "",
        ...
        /// <param name="id">The id registered by <see cref="BoltFieldsAttribute"/>.</param>
        public BoltFieldDefaultValuesAttribute(uint id) {
            Id = id.ToString();
            Size = 8.0;
            Standard = "A";
            DistXText = "";
        ...
        /// UseWasher1 = 0, UseWasher2 = 0, UseWasher3 = 1.</remarks>
        /// <param name="id">The id registered by <see cref="BoltFieldsAttribute"/>.</param>
        public BoltFieldDefaultValuesAttribute(string id) {
            Id = id;
            Size = 8.0;
            Standard = "A";
            DistXText = "";
        ...
        public BoltFieldDefaultValuesAttribute(
            uint id, double size = 8.0, string standard = "A", string distXText = "", string distYText = "",
            int type = 0, int threadInMaterial = 1, double length = 40.0, double cutLength = 100.0,
            ...
            double slottedHoleX = 0.0, double slottedHoleY = 0.0, int rotateSlots = 2, int isBolt = 1, int useNut1 = 1,
            int useNut2 = 0, int useWasher1 = 0, int useWasher2 = 0, int useWasher3 = 1) {
        ...
        /// <param name="useWasher3">The default value for the "Washer3" property of "BoltGroup".</param>
        public BoltFieldDefaultValuesAttribute(
            string id, double size = 8.0, string standard = "A", string distXText = "", string distYText = "",
            int type = 0, int threadInMaterial = 1, double length = 40.0, double cutLength = 100.0,
            double extraLength = 0.0, double tolerance = 2.0, int plainType = 0, double blindHoleDepth = 0.0,
            int hole1 = 1, int hole2 = 1, int hole3 = 0, int hole4 = 0, int hole5 = 0, int holeType = 0,
            double slottedHoleX = 0.0, double slottedHoleY = 0.0, int rotateSlots = 2, int isBolt = 1, int useNut1 = 1,
