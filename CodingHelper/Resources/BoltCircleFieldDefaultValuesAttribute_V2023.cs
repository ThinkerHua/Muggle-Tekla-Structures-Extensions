...
namespace Muggle.TsExtensions.CodingHelper.Generators {
    ...
    public class BoltCircleFieldDefaultValuesAttribute : Attribute {
        ...
        public BoltCircleFieldDefaultValuesAttribute(
            ...
            int holeType = 0, double slottedHoleX = 0.0, double slottedHoleY = 0.0, double slotOffsetX = 0.0, 
            double slotOffsetY = 0.0, int rotateSlots = 2, int isBolt = 1, int useNut1 = 1, int useNut2 = 0, 
