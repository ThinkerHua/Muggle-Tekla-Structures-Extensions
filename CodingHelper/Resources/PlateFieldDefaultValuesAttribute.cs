...
namespace Muggle.TsExtensions.CodingHelper.Generators {
    ...
    public class PlateFieldDefaultValuesAttribute : Attribute {
        ...
        public PlateFieldDefaultValuesAttribute(uint id) {
            Id = id.ToString();
            Thickness = 0.0;
            Breadth = 0.0;
            Height = 0.0;
        ...
        /// PartStartNumber = 1.</remarks>
        /// <param name="id">The id registered by <see cref="PartFieldsAttribute"/>.</param>
        public PlateFieldDefaultValuesAttribute(string id) {
            Id = id;
            Thickness = 0.0;
            Breadth = 0.0;
            Height = 0.0;
        ...
        public PlateFieldDefaultValuesAttribute(
            uint id, double thickness = 0, double breadth = 0, double height = 0, string material = "",
        ...
        /// <param name="partStartNumber">The default value for the "StartNumber" property of "Part.PartNumber".</param>
        public PlateFieldDefaultValuesAttribute(
            string id, double thickness = 0, double breadth = 0, double height = 0, string material = "",
            string name = "", string finish = "", int @class = 99, string assemblyPrefix = "A-",
            int assemblyStartNumber = 1, string partPrefix = "P", int partStartNumber = 1) {
