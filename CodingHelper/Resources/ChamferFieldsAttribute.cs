...
namespace Muggle.TsExtensions.CodingHelper.Generators {
    ...
    /// <summary>
    /// Register the chamfer fields that need to be generated for the applied class,
    ...
    public class ChamferFieldsAttribute : Attribute {
        public string[] Ids { get; set; }

        /// <summary>
        /// Register the chamfer fields using the given ids.
        /// </summary>
        public ChamferFieldsAttribute(params uint[] ids) {
        ...
        /// Register the chamfer fields using the given ids.
        /// </summary>
        public ChamferFieldsAttribute(params string[] ids) {
            Ids = ids;
        }
