...
namespace Muggle.TsExtensions.CodingHelper.Generators {
    ...
    /// <summary>
    /// Register the bolt circle properties (with default values) that need to be generated for the applied class.
    /// </summary>
    ...
    public class BoltCirclePropertiesAttribute : Attribute {
        ...
        /// <summary>
        /// Register bolt circle properties with preset default values using the given id.
        /// </summary>
        ...
        /// <param name="id">The bolt circle id.</param>
        public BoltCirclePropertiesAttribute(uint id) {
            Id = id.ToString();
            Size = 8.0;
            Standard = "A";
            NumberOfBolts = 6;
        ...
        /// UseWasher1 = 0, UseWasher2 = 0, UseWasher3 = 1.</remarks>
        /// <param name="id">The bolt circle id.</param>
        public BoltCirclePropertiesAttribute(string id) {
            Id = id;
            Size = 8.0;
            Standard = "A";
            NumberOfBolts = 6;
        ...
        /// <summary>
        /// Register bolt circle properties with default values using the given id.
        /// </summary>
        /// <param name="id">The bolt circle id.</param>
