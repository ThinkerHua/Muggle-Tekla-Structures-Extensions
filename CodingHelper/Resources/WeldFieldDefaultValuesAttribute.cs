...
namespace Muggle.TsExtensions.CodingHelper.Generators {
    ...
    public class WeldFieldDefaultValuesAttribute : Attribute {
        ...
        /// <param name="id">The id registered by <see cref="WeldFieldsAttribute"/>.</param>
        public WeldFieldDefaultValuesAttribute(uint id) {
            Id = id.ToString();
            TypeAbove = 0;
            TypeBelow = 0;
            SizeAbove = 0;
        ...
        /// placement = 0, preparation = 0, intermittent = 0, referenceText = "".</remarks>
        /// <param name="id">The id registered by <see cref="WeldFieldsAttribute"/>.</param>
        public WeldFieldDefaultValuesAttribute(string id) {
            Id = id;
            TypeAbove = 0;
            TypeBelow = 0;
            SizeAbove = 0;
        ...
        public WeldFieldDefaultValuesAttribute(
            uint id, int typeAbove = 0, int typeBelow = 0, double sizeAbove = 0.0, double sizeBelow = 0.0,
        ...
        /// <param name="referenceText">The default value for the "ReferenceText" property of "BaseWeld".</param>
        public WeldFieldDefaultValuesAttribute(
            string id, int typeAbove = 0, int typeBelow = 0, double sizeAbove = 0.0, double sizeBelow = 0.0,
            double angleAbove = 0.0, double angleBelow = 0.0, int contourAbove = 0, int contourBelow = 0,
            int finishAbove = 0, int finishBelow = 0, double rootFaceAbove = 0.0, double rootFaceBelow = 0.0,
            double effectiveThroatAbove = 0.0, double effectiveThroatBelow = 0.0,
            double rootOpeningAbove = 0.0, double rootOpeningBelow = 0.0,
